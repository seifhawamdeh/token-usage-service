...
CREATE TABLE IF NOT EXISTS project_cwds (
    ...
    PRIMARY KEY (host_id, cwd)
);

UPDATE schema_meta SET value = '4' WHERE key = 'snapshot_schema_version';
INSERT INTO schema_meta (key, value) VALUES ('snapshot_schema_version', '4')
